...
title: ' Web Scraping Instead of Using the API'
description: 'Scraping YouTube chat data instead of using Google''s bad api. '
author: Edward Deaver
categories:
  - web-scraping
tags:
  - python
image: assets/blog/selenium_logo.webp
---
...
This solution isn’t perfect by any means. All of this has the overhead performance cost of running a separate installation of Chrome web browser, but it works.
